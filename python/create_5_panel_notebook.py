...
with open('/mnt/c/proprojet/black-ice-detector/python/visualization_5_panels.ipynb', 'w', encoding='utf-8') as f:
    json.dump(notebook, f, ensure_ascii=False, indent=2)

print("visualization_5_panels.ipynb generated successfully.")
