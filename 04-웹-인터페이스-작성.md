...
외부 DHT22 보드의 온습도 값은 **수동 입력 영역**에 반영됩니다.
...
- 거리 값을 시각적으로 표시
- 연결 상태 및 측정 상태 표시
- 외부 온습도 보드 값을 수동 입력하여 측정 요청에 포함
...
온도/습도는 외부 보드에서 읽은 값을 **사용자가 수동으로 입력**합니다:
